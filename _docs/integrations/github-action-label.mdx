...
description: "In this guide, we will configure the EkLine GitHub Action to run only when a specific label, called 'ekline', is added to a pull request."
position: 2
---
...
```
4. Save the changes to the **`ekline.yml`** file.
